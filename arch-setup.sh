...
sudo pacman -Syu alsa-utils greetd greetd-tuigreet gtk4 hyprland kitty mako neovim openssh pipewire pipewire-jack qt6-wayland rustup ttf-hack-nerd ttf-ibm-plex ufw waybar wayland wget wireplumber zsh zsh-completions zsh-syntax-highlighting
