...
sudo pacman -Syu alsa-utils greetd greetd-tuigreet gtk4 gvfs hyprland kitty mako neovim openssh pipewire pipewire-jack qt6-wayland rustup thunar thunar-volman ttf-hack-nerd ttf-ibm-plex udisks2 ufw waybar wayland wget wireplumber zsh zsh-completions zsh-syntax-highlighting
